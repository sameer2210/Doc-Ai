...
describe('RequestContextInterceptor', () => {
  let interceptor: RequestContextInterceptor<any>;
  ...
  beforeEach(async () => {
    ...
    interceptor = module.get<RequestContextInterceptor<any>>(RequestContextInterceptor);
    contextService = module.get<RequestContextService>(RequestContextService);
  });

  it('should set X-Request-Id header and format data response', (done) => {
